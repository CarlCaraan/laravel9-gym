...
@section('title') Add Facility | Respond Fitness @endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="col-6">
                        <form class="form-horizontal" method="POST" action="{{ route('user.facilities.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label for="" class="col-sm-3 text-right control-label col-form-label">Facility Image</label>
                                <div class="col-md-9 text-left">
                                    <img class="img-thumbnail mb-3" style="width: 400px; height: 400px;" src="{{ url('upload/user_siteinfo/facilities/default_photo.png')}}" id="show_image" alt="User Avatar">
                                </div>
                            </div>
                            <div class="form-group row">
