                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('user.herosection.update', $editData->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 text-left">
                                    <img class="img-thumbnail mb-3" style="width: 400px; height: 400px;" src="{{ (!empty($editData->image)) ? url('upload/user_siteinfo/herosection/'.$editData->image) : url('upload/user_siteinfo/herosection/default_photo.jpg') }}" id="show_image" alt="User Avatar">
                                </div>
                            </div>
                            <div class="form-group row">
