...
<head>
    ...
    <title>Forgot Password | Samgyup Fitness Center</title>
    <!-- Custom CSS -->
            ...
            <div class="auth-box border-top border-secondary">
                <div id="loginform">
                    ...
                    <form class="form-horizontal m-t-20" id="loginform" method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="center">
                            <button class="btn btn-success float-right auth-btn" type="submit">Send {{ __('Email Password Reset Link') }}</button>
                        </div>
                    </form>
                </div>
            </div>
