...
@endphp
<div class="container">
    <nav class="navbar navbar-expand-lg bg-white navbar-light py-lg-0" data-wow-delay="0.1s">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="{{ route('customer.appointment.view') }}" class="nav-item nav-link {{ ($prefix == '/booking') ? 'active' : '' }}">+ Add Schedule</a>
