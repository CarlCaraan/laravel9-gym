                    ...
                    <div class="col-12">
                        <form class="form-horizontal" method="POST" action="{{ route('customer.profile.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="image" class="col-xl-3 text-right control-label col-form-label">Profile Avatar</label>
                            ...
                            <div class="form-group row">
                                <label for="image" class="col-xl-3 text-right control-label col-form-label">Image</label>
                                <div class="col-xl-9">
                            ...
                            <div class="form-group row">
                                <label for="image" class="col-xl-3 text-right control-label col-form-label"></label>
                                <div class="col-xl-9">
                            ...
                            <br />
                            <div class="form-group row">
                                <label for="first_name" class="col-xl-3 text-right control-label col-form-label">First Name</label>
                                <div class="col-xl-9">
                            ...
                            <br>
                            <div class="form-group row">
                                <label for="last_name" class="col-xl-3 text-right control-label col-form-label">Last Name</label>
                                <div class="col-xl-9">
                            ...
                            <br>
                            <div class="form-group row">
                                <label for="email" class="col-xl-3 text-right control-label col-form-label">Email Address</label>
                                <div class="col-xl-9">
                            ...
                            <br>
                            <div class="form-group row">
                                <label for="gender" class="col-xl-3 text-right control-label col-form-label">Gender</label>
                                <div class="col-xl-9">
                ...
                <div class="card-body">
                    <div class="col-12">
                        <form class="form-horizontal" method="POST" action="{{ route('customer.password.update') }}">
                            ...
                            <br />
                            <div class="form-group row">
                                <label for="current_password" class="col-xl-3 text-right control-label col-form-label">Current Password</label>
                                <div class="col-xl-9">
                            ...
                            <div class="form-group row">
                                <label for="password" class="col-xl-3 text-right control-label col-form-label">New Password</label>
                                <div class="col-xl-9">
                            ...
                            <div class="form-group row">
                                <label for="password_confirmation" class="col-xl-3 text-right control-label col-form-label">Confirm Password</label>
                                <div class="col-xl-9">
